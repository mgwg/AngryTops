...
histograms['corr_t_had_px']    = TH2F( "corr_t_had_px",      ";True Hadronic top p_{x} [GeV];Fitted Hadronic top p_{x} [GeV]", 50, -300., 300., 50, -300., 300. )
histograms['corr_t_had_py']    = TH2F( "corr_t_had_py",      ";True Hadronic top p_{y} [GeV];Fitted Hadronic top p_{y} [GeV]", 50, -300., 300., 50, -300., 300. )
histograms['corr_t_had_pz']    = TH2F( "corr_t_had_pz",      ";True Hadronic top p_{z} [GeV];Fitted Hadronic top p_{z} [GeV]", 50, -400., 400., 50, -400., 400. )
...
histograms['corr_b_lep_px']    = TH2F( "corr_b_lep_px",      ";True Leptonic bot p_{x} [GeV];Fitted Leptonic bot p_{x} [GeV]", 50, -300., 300., 50, -300., 300. )
histograms['corr_b_lep_py']    = TH2F( "corr_b_lep_py",      ";True Leptonic bot p_{y} [GeV];Fitted Leptonic bot p_{y} [GeV]", 50, -300., 300., 50, -300., 300. )
histograms['corr_b_lep_pz']    = TH2F( "corr_b_lep_pz",      ";True Leptonic bot p_{z} [GeV];Fitted Leptonic bot p_{z} [GeV]", 50, -400., 400., 50, -400., 400. )
