...
histograms['corr_b_lep_px']    = TH2F( "corr_b_lep_px",      ";True Leptonic bot p_{x} [GeV];Fitted Leptonic bot p_{x} [GeV]", 50, -300., 300., 50, -1000., 1000. )
histograms['corr_b_lep_py']    = TH2F( "corr_b_lep_py",      ";True Leptonic bot p_{y} [GeV];Fitted Leptonic bot p_{y} [GeV]", 50, -300., 300., 50, -1000., 1000. )
histograms['corr_b_lep_pz']    = TH2F( "corr_b_lep_pz",      ";True Leptonic bot p_{z} [GeV];Fitted Leptonic bot p_{z} [GeV]", 50, -400., 400., 50, -1000., 1000. )
...
histograms['corr_b_had_px']    = TH2F( "corr_b_had_px",      ";True Hadronic bot p_{x} [GeV];Fitted Hadronic bot p_{x} [GeV]", 50, -300., 300., 50, -1000., 1000. )
histograms['corr_b_had_py']    = TH2F( "corr_b_had_py",      ";True Hadronic bot p_{y} [GeV];Fitted Hadronic bot p_{y} [GeV]", 50, -300., 300., 50, -1000., 1000. )
histograms['corr_b_had_pz']    = TH2F( "corr_b_had_pz",      ";True Hadronic bot p_{z} [GeV];Fitted Hadronic bot p_{z} [GeV]", 50, -400., 400., 50, -1000., 1000. )
