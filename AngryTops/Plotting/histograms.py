...
# residuals
histograms['diff_W_had_px']       = TH1F( "diff_W_had_px",  ";Hadronic W p_{x} [GeV]", 500, -500., 500. )
histograms['diff_W_had_py']       = TH1F( "diff_W_had_py",  ";Hadronic W p_{y} [GeV]", 500, -500., 500. )
histograms['diff_W_had_pz']       = TH1F( "diff_W_had_pz",  ";Hadronic W p_{z} [GeV]", 500, -500., 500. )
histograms['diff_W_had_pt']       = TH1F( "diff_W_had_pt",  ";Hadronic W p_{T} [GeV]", 500, -500., 500. )
histograms['diff_W_had_y']        = TH1F( "diff_W_had_y",   ";Hadronic W #eta", 500, -5., 5. )
histograms['diff_W_had_phi']      = TH1F( "diff_W_had_phi", ";Hadronic W #phi", 500, -3.2, 3.2 )
histograms['diff_W_had_E']        = TH1F( "diff_W_had_E",   ";Hadronic W E [GeV]", 500, -500., 500. )
histograms['diff_W_had_m']        = TH1F( "diff_W_had_m",   ";Hadronic W m [GeV]", 500, -300., 300.  )

histograms['diff_b_had_px']       = TH1F( "diff_b_had_px",  ";Hadronic b p_{x} [GeV]", 500, -500., 500. )
histograms['diff_b_had_py']       = TH1F( "diff_b_had_py",  ";Hadronic b p_{y} [GeV]", 500, -500., 500. )
histograms['diff_b_had_pz']       = TH1F( "diff_b_had_pz",  ";Hadronic b p_{z} [GeV]", 500, -500., 500. )
histograms['diff_b_had_pt']       = TH1F( "diff_b_had_pt",  ";Hadronic b p_{T} [GeV]", 500, -500., 500. )
histograms['diff_b_had_y']        = TH1F( "diff_b_had_y",   ";Hadronic b #eta", 500, -5., 5. )
histograms['diff_b_had_phi']      = TH1F( "diff_b_had_phi", ";Hadronic b #phi", 500, -3.2, 3.2 )
histograms['diff_b_had_E']        = TH1F( "diff_b_had_E",   ";Hadronic b E [GeV]", 500, -500., 500. )
histograms['diff_b_had_m']        = TH1F( "diff_b_had_m",   ";Hadronic b m [GeV]", 500, -300., 300.  )

histograms['diff_t_had_px']       = TH1F( "diff_t_had_px",  ";Hadronic t p_{x} [GeV]", 500, -500., 500. )
histograms['diff_t_had_py']       = TH1F( "diff_t_had_py",  ";Hadronic t p_{y} [GeV]", 500, -500., 500. )
histograms['diff_t_had_pz']       = TH1F( "diff_t_had_pz",  ";Hadronic t p_{z} [GeV]", 500, -500., 500. )
histograms['diff_t_had_pt']       = TH1F( "diff_t_had_pt",  ";Hadronic t p_{T} [GeV]", 500, -500., 500. )
histograms['diff_t_had_y']        = TH1F( "diff_t_had_y",   ";Hadronic t #eta", 500, -5., 5. )
histograms['diff_t_had_phi']      = TH1F( "diff_t_had_phi", ";Hadronic t #phi", 500, -3.2, 3.2 )
histograms['diff_t_had_E']        = TH1F( "diff_t_had_E",   ";Hadronic t E [GeV]", 500, -500., 500. )
histograms['diff_t_had_m']        = TH1F( "diff_t_had_m",   ";Hadronic t m [GeV]", 500, -300., 300.  )

histograms['diff_W_lep_px']       = TH1F( "diff_W_lep_px",   ";Leptonic W p_{x} [GeV]", 500, -500., 500. )
histograms['diff_W_lep_py']       = TH1F( "diff_W_lep_py",   ";Leptonic W p_{y} [GeV]", 500, -500., 500. )
histograms['diff_W_lep_pz']       = TH1F( "diff_W_lep_pz",   ";Leptonic W p_{z} [GeV]", 500, -500., 500. )
histograms['diff_W_lep_pt']       = TH1F( "diff_W_lep_pt",   ";Leptonic W p_{T} [GeV]", 500, -500., 500. )
histograms['diff_W_lep_y']        = TH1F( "diff_W_lep_y",    ";Leptonic W #eta", 500, -5., 5. )
histograms['diff_W_lep_phi']      = TH1F( "diff_W_lep_phi",  ";Leptonic W #phi", 500, -3.2, 3.2 )
histograms['diff_W_lep_E']        = TH1F( "diff_W_lep_E",    ";Leptonic W E [GeV]", 500, -500., 500. )
histograms['diff_W_lep_m']        = TH1F( "diff_W_lep_m",    ";Leptonic W m [GeV]", 500, -300., 300. )

histograms['diff_b_lep_px']       = TH1F( "diff_b_lep_px",   ";Leptonic b p_{x} [GeV]", 500, -500., 500. )
histograms['diff_b_lep_py']       = TH1F( "diff_b_lep_py",   ";Leptonic b p_{y} [GeV]", 500, -500., 500. )
histograms['diff_b_lep_pz']       = TH1F( "diff_b_lep_pz",   ";Leptonic b p_{z} [GeV]", 500, -500., 500. )
histograms['diff_b_lep_pt']       = TH1F( "diff_b_lep_pt",   ";Leptonic b p_{T} [GeV]", 500, -500., 500. )
histograms['diff_b_lep_y']        = TH1F( "diff_b_lep_y",    ";Leptonic b #eta", 500, -5., 5. )
histograms['diff_b_lep_phi']      = TH1F( "diff_b_lep_phi",  ";Leptonic b #phi", 500, -3.2, 3.2 )
histograms['diff_b_lep_E']        = TH1F( "diff_b_lep_E",    ";Leptonic b E [GeV]", 500, -500., 500. )
histograms['diff_b_lep_m']        = TH1F( "diff_b_lep_m",    ";Leptonic b m [GeV]", 500, -300., 300. )

histograms['diff_t_lep_px']       = TH1F( "diff_t_lep_px",   ";Leptonic t p_{x} [GeV]", 500, -500., 500. )
histograms['diff_t_lep_py']       = TH1F( "diff_t_lep_py",   ";Leptonic t p_{y} [GeV]", 500, -500., 500. )
histograms['diff_t_lep_pz']       = TH1F( "diff_t_lep_pz",   ";Leptonic t p_{z} [GeV]", 500, -500., 500. )
histograms['diff_t_lep_pt']       = TH1F( "diff_t_lep_pt",   ";Leptonic t p_{T} [GeV]", 500, -500., 500. )
histograms['diff_t_lep_y']        = TH1F( "diff_t_lep_y",    ";Leptonic t #eta", 500, -5., 5. )
histograms['diff_t_lep_phi']      = TH1F( "diff_t_lep_phi",  ";Leptonic t #phi", 500, -3.2, 3.2 )
histograms['diff_t_lep_E']        = TH1F( "diff_t_lep_E",    ";Leptonic t E [GeV]", 500, -500., 500. )
histograms['diff_t_lep_m']        = TH1F( "diff_t_lep_m",    ";Leptonic t m [GeV]", 500, -300., 300. )
