...
histograms['corr_W_had_pt']    = TH2F( "corr_W_had_pt",      ";True Hadronic W p_{T} [GeV];Fitted Hadronic top p_{T} [GeV]", 50, 0., 300., 50, 0., 300. )
histograms['corr_W_had_px']    = TH2F( "corr_W_had_px",      ";True Hadronic bot p_{x} [GeV];Fitted Hadronic bot p_{x} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_W_had_py']    = TH2F( "corr_W_had_py",      ";True Hadronic bot p_{y} [GeV];Fitted Hadronic bot p_{y} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_W_had_pz']    = TH2F( "corr_W_had_pz",      ";True Hadronic bot p_{z} [GeV];Fitted Hadronic bot p_{z} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
...
histograms['corr_W_lep_pt']    = TH2F( "corr_W_lep_pt",      ";True Leptonic W p_{T} [GeV];Fitted Leptonic top p_{T} [GeV]", 50, 0., 300., 50, 0., 300. )
histograms['corr_W_lep_px']    = TH2F( "corr_W_lep_px",      ";True Leptonic bot p_{x} [GeV];Fitted Leptonic bot p_{x} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_W_lep_py']    = TH2F( "corr_W_lep_py",      ";True Leptonic bot p_{y} [GeV];Fitted Leptonic bot p_{y} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_W_lep_pz']    = TH2F( "corr_W_lep_pz",      ";True Leptonic bot p_{z} [GeV];Fitted Leptonic bot p_{z} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
...
histograms['corr_W_lep_E']     = TH2F( "corr_W_lep_E",       ";True Leptonic W E [GeV];Fitted Leptonic top E [GeV]", 50, 70., 400., 50, 70., 400. )
