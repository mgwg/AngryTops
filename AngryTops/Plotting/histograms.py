...
histograms['corr_t_had_px']    = TH2F( "corr_t_had_px",      ";True Hadronic top p_{x} [GeV];Fitted Hadronic top p_{x} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_t_had_py']    = TH2F( "corr_t_had_py",      ";True Hadronic top p_{y} [GeV];Fitted Hadronic top p_{y} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_t_had_pz']    = TH2F( "corr_t_had_pz",      ";True Hadronic top p_{z} [GeV];Fitted Hadronic top p_{z} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
...
histograms['corr_t_lep_px']    = TH2F( "corr_t_lep_px",      ";True Leptonic top p_{x} [GeV];Fitted Leptonic top p_{x} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_t_lep_py']    = TH2F( "corr_t_lep_py",      ";True Leptonic top p_{y} [GeV];Fitted Leptonic top p_{y} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_t_lep_pz']    = TH2F( "corr_t_lep_pz",      ";True Leptonic top p_{z} [GeV];Fitted Leptonic top p_{z} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
...
histograms['corr_b_lep_pt']    = TH2F( "corr_b_lep_pt",     ";True Leptonic bot p_{T} [GeV];Fitted Leptonic bot p_{T} [GeV]", 50, 0., 300., 50, 0., 300. )
histograms['corr_b_lep_px']    = TH2F( "corr_b_lep_px",      ";True Leptonic bot p_{x} [GeV];Fitted Leptonic bot p_{x} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_b_lep_py']    = TH2F( "corr_b_lep_py",      ";True Leptonic bot p_{y} [GeV];Fitted Leptonic bot p_{y} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_b_lep_pz']    = TH2F( "corr_b_lep_pz",      ";True Leptonic bot p_{z} [GeV];Fitted Leptonic bot p_{z} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
...
histograms['corr_b_lep_E']     = TH2F( "corr_b_lep_E",      ";True Leptonic bot E [GeV];Fitted Leptonic bot E [GeV]", 50, 0., 300., 50, 0., 300. )
histograms['corr_b_lep_m']     = TH2F( "corr_b_lep_m",      ";True Leptonic bot m [GeV];Fitted Leptonic bot m [GeV]", 25, 170., 175., 20, 150., 250. )

histograms['corr_b_had_pt']    = TH2F( "corr_b_had_pt",      ";True Hadronic bot p_{T} [GeV];Fitted Hadronic bot p_{T} [GeV]", 50, 0., 300., 50, 0., 300. )
histograms['corr_b_had_px']    = TH2F( "corr_b_had_px",      ";True Hadronic bot p_{x} [GeV];Fitted Hadronic bot p_{x} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_b_had_py']    = TH2F( "corr_b_had_py",      ";True Hadronic bot p_{y} [GeV];Fitted Hadronic bot p_{y} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_b_had_pz']    = TH2F( "corr_b_had_pz",      ";True Hadronic bot p_{z} [GeV];Fitted Hadronic bot p_{z} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
...
histograms['corr_b_had_E']     = TH2F( "corr_b_had_E",       ";True Hadronic bot E [GeV];Fitted Hadronic bot E [GeV]", 50, 0., 300., 50, 0., 300. )
histograms['corr_b_had_m']     = TH2F( "corr_b_had_m",       ";True Hadronic bot m [GeV];Fitted Hadronic bot m [GeV]", 25, 170., 175., 20, 150., 250. )

histograms['corr_W_had_pt']    = TH2F( "corr_W_had_pt",      ";True Hadronic W p_{T} [GeV];Fitted Hadronic W p_{T} [GeV]", 50, 0., 300., 50, 0., 300. )
histograms['corr_W_had_px']    = TH2F( "corr_W_had_px",      ";True Hadronic W p_{x} [GeV];Fitted Hadronic W p_{x} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_W_had_py']    = TH2F( "corr_W_had_py",      ";True Hadronic W p_{y} [GeV];Fitted Hadronic W p_{y} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_W_had_pz']    = TH2F( "corr_W_had_pz",      ";True Hadronic W p_{z} [GeV];Fitted Hadronic W p_{z} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
...
histograms['corr_W_had_E']     = TH2F( "corr_W_had_E",       ";True Hadronic W E [GeV];Fitted Hadronic top E [GeV]", 50, 70., 400., 50, 70., 400. )
histograms['corr_W_had_m']     = TH2F( "corr_W_had_m",       ";True Hadronic W m [GeV];Fitted Hadronic top m [GeV]", 25, 170., 175., 20, 150., 250. )

histograms['corr_W_lep_pt']    = TH2F( "corr_W_lep_pt",      ";True Leptonic W p_{T} [GeV];Fitted Leptonic W p_{T} [GeV]", 50, 0., 300., 50, 0., 300. )
histograms['corr_W_lep_px']    = TH2F( "corr_W_lep_px",      ";True Leptonic W p_{x} [GeV];Fitted Leptonic W p_{x} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_W_lep_py']    = TH2F( "corr_W_lep_py",      ";True Leptonic W p_{y} [GeV];Fitted Leptonic W p_{y} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_W_lep_pz']    = TH2F( "corr_W_lep_pz",      ";True Leptonic W p_{z} [GeV];Fitted Leptonic W p_{z} [GeV]", 50, -1000., 1000., 50, -1000., 1000. )
histograms['corr_W_lep_y']     = TH2F( "corr_W_lep_y",       ";True Leptonic W y;Fitted Leptonic W y", 25, -5., 5., 25, -5., 5. )
histograms['corr_W_lep_phi']   = TH2F( "corr_W_lep_phi",     ";True Leptonic W #phi;Fitted Leptonic W #phi", 16, -3.2, 3.2, 16, -3.2, 3.2 )
histograms['corr_W_lep_E']     = TH2F( "corr_W_lep_E",       ";True Leptonic W E [GeV];Fitted Leptonic W E [GeV]", 50, 70., 400., 50, 70., 400. )
histograms['corr_W_lep_m']     = TH2F( "corr_W_lep_m",       ";True Leptonic W m [GeV];Fitted Leptonic W m [GeV]", 25, 170., 175., 20, 150., 250. )
