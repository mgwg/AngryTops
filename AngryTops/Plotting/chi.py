...
# Distribution of chi-squareds for each variable individually.
...
# Distribution of chi-squareds summing 12 variables
...
for i in range(n_events):
    ...
    #  a chi-squared distribution with 12 degrees of freedom.
