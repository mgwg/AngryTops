...
# To create histograms of the sum of the angle between the W+b and t jets 
...
# True
histograms['Wbt_had_angle_true']        = TH1F( "Wbt_had_angle_true",   ";Hadronic Angle [Rad]", 200, 0.0, 1.6)
histograms['Wbt_lep_angle_true']        = TH1F( "Wbt_lep_angle_true",   ";Leptonic Angle [Rad]", 200, 0.0, 1.6)
# Fitted
histograms['Wbt_had_angle_fitted']        = TH1F( "Wbt_had_angle_fitted",   ";Hadronic Angle [Rad]", 200, 0.0, 1.6)
histograms['Wbt_lep_angle_fitted']        = TH1F( "Wbt_lep_angle_fitted",   ";Leptonic Angle [Rad]", 200, 0.0, 1.6)
...
if __name__==   "__main__":
    ...
    attributes = ['Wbt_had_angle', 'Wbt_lep_angle']
