...
# 2D correlations
histograms['corr_t_had_pt']    = TH2F( "corr_t_had_pt",      ";True Hadronic top p_{T} [GeV];Fitted Hadronic top p_{T} [GeV]", 50, 0., 400., 50, 0., 400. )
histograms['corr_t_had_px']    = TH2F( "corr_t_had_px",      ";True Hadronic top p_{x} [GeV];Fitted Hadronic top p_{x} [GeV]", 50, -300., 300., 50, -1000., 1000. )
histograms['corr_t_had_py']    = TH2F( "corr_t_had_py",      ";True Hadronic top p_{y} [GeV];Fitted Hadronic top p_{y} [GeV]", 50, -300., 300., 50, -1000., 1000. )
histograms['corr_t_had_pz']    = TH2F( "corr_t_had_pz",      ";True Hadronic top p_{z} [GeV];Fitted Hadronic top p_{z} [GeV]", 50, -400., 400., 50, -1000., 1000. )
...
histograms['corr_t_had_E']     = TH2F( "corr_t_had_E",       ";True Hadronic top E [GeV];Fitted Hadronic top E [GeV]", 50, 150., 500., 50, 150., 500. )
histograms['corr_t_had_m']     = TH2F( "corr_t_had_m",       ";True Hadronic top m [GeV];Fitted Hadronic top m [GeV]", 25, 170., 175., 20, 150., 250. )

histograms['corr_t_lep_pt']    = TH2F( "corr_t_lep_pt",     ";True Leptonic top p_{T} [GeV];Fitted Leptonic top p_{T} [GeV]", 50, 0., 400., 50, 0., 400. )
histograms['corr_t_lep_px']    = TH2F( "corr_t_lep_px",      ";True Leptonic top p_{x} [GeV];Fitted Leptonic top p_{x} [GeV]", 50, -300., 300., 50, -1000., 1000. )
histograms['corr_t_lep_py']    = TH2F( "corr_t_lep_py",      ";True Leptonic top p_{y} [GeV];Fitted Leptonic top p_{y} [GeV]", 50, -300., 300., 50, -1000., 1000. )
histograms['corr_t_lep_pz']    = TH2F( "corr_t_lep_pz",      ";True Leptonic top p_{z} [GeV];Fitted Leptonic top p_{z} [GeV]", 50, -400., 400., 50, -1000., 1000. )
...
histograms['corr_t_lep_E']     = TH2F( "corr_t_lep_E",      ";True Leptonic top E [GeV];Fitted Leptonic top E [GeV]", 50, 150., 500., 50, 150., 500. )
...
# FILL TREES
    ...
    if i < 10:
      PrintOut( t_had_true, t_had_fitted, "Hadronic t" )
      PrintOut( t_lep_true, t_lep_fitted, "Leptonic t" )
