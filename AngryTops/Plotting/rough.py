...
ofilename = "{}/predictions_May21".format(output_dir)
# Open output file
...
tree.Branch( 'b_jet1_px_obs', b_jet1_px_obs, 'b_jet1_px_obs/F')
tree.Branch( 'b_jet1_py_obs', b_jet1_py_obs, 'b_jet1_py_obs/F')
tree.Branch( 'b_jet1_pz_obs', b_jet1_pz_obs, 'b_jet1_py_obs/F')
tree.Branch( 'b_jet1_E_obs', b_jet1_E_obs, 'b_jet1_E_obs/F')
tree.Branch( 'b_jet1_m_obs', b_jet1_m_obs, 'b_jet1_m_obs/F')
tree.Branch( 'b_jet1_btag_obs', b_jet1_pt_obs, 'b_jet1_btag_obs/F')
tree.Branch( 'b_jet2_px_obs', b_jet2_px_obs, 'b_jet2_px_obs/F')
tree.Branch( 'b_jet2_py_obs', b_jet2_py_obs, 'b_jet2_py_obs/F')
tree.Branch( 'b_jet2_pz_obs', b_jet2_pz_obs, 'b_jet2_py_obs/F')
tree.Branch( 'b_jet2_E_obs', b_jet2_E_obs, 'b_jet2_E_obs/F')
tree.Branch( 'b_jet2_m_obs', b_jet2_m_obs, 'b_jet2_m_obs/F')
tree.Branch( 'b_jet2_btag_obs', b_jet2_pt_obs, 'b_jet2_btag_obs/F')
tree.Branch( 'b_jet3_px_obs', b_jet3_px_obs, 'b_jet3_px_obs/F')
tree.Branch( 'b_jet3_py_obs', b_jet3_py_obs, 'b_jet3_py_obs/F')
tree.Branch( 'b_jet3_pz_obs', b_jet3_pz_obs, 'b_jet3_py_obs/F')
tree.Branch( 'b_jet3_E_obs', b_jet3_E_obs, 'b_jet3_E_obs/F')
tree.Branch( 'b_jet3_m_obs', b_jet3_m_obs, 'b_jet3_m_obs/F')
tree.Branch( 'b_jet3_btag_obs', b_jet3_pt_obs, 'b_jet3_btag_obs/F')
tree.Branch( 'b_jet4_px_obs', b_jet4_px_obs, 'b_jet4_px_obs/F')
tree.Branch( 'b_jet4_py_obs', b_jet4_py_obs, 'b_jet4_py_obs/F')
tree.Branch( 'b_jet4_pz_obs', b_jet4_pz_obs, 'b_jet4_py_obs/F')
tree.Branch( 'b_jet4_E_obs', b_jet4_E_obs, 'b_jet4_E_obs/F')
tree.Branch( 'b_jet4_m_obs', b_jet4_m_obs, 'b_jet4_m_obs/F')
tree.Branch( 'b_jet4_btag_obs', b_jet4_pt_obs, 'b_jet4_btag_obs/F')
tree.Branch( 'b_jet5_px_obs', b_jet5_px_obs, 'b_jet5_px_obs/F')
tree.Branch( 'b_jet5_py_obs', b_jet5_py_obs, 'b_jet5_py_obs/F')
tree.Branch( 'b_jet5_pz_obs', b_jet5_pz_obs, 'b_jet5_py_obs/F')
tree.Branch( 'b_jet5_E_obs', b_jet5_E_obs, 'b_jet5_E_obs/F')
tree.Branch( 'b_jet5_m_obs', b_jet5_m_obs, 'b_jet5_m_obs/F')
tree.Branch( 'b_jet5_btag_obs', b_jet5_pt_obs, 'b_jet5_btag_obs/F')
tree.Branch( 'b_jetmu_px_obs', b_jetmu_px_obs, 'b_jetmu_px_obs/F')
tree.Branch( 'b_jetmu_py_obs', b_jetmu_py_obs, 'b_jetmu_py_obs/F')
tree.Branch( 'b_jetmu_pz_obs', b_jetmu_pz_obs, 'b_jetmu_py_obs/F')
tree.Branch( 'b_jetmu_T0_obs', b_jetmu_T0_obs, 'b_jetmu_T0_obs/F')
tree.Branch( 'b_jelep5_ET_obs', b_jetlep_ET_obs, 'b_jetlep_ET_obs/F')
tree.Branch( 'b_jetlep_phi_obs', b_jetlep_phi_obs, 'b_jetlep_phi_obs/F')
...
for i in range(n_events):
    ...
    b_jet1_px_obs   = jet_1_vect.Px()
    b_jet1_py_obs   = jet_1_vect.Py()
    b_jet1_pz_obs   = jet_1_vect.Pz()
    b_jet1_E_obs    = jet_1_vect.E()
    b_jet1_m_obs    = jet_1_vect.M()
    b_jet1_btag_obs   = jet_1[i][5]
    b_jet2_px_obs   = jet_2_vect.Px()
    b_jet2_py_obs   = jet_2_vect.Py()
    b_jet2_pz_obs   = jet_2_vect.Pz()
    b_jet2_E_obs    = jet_2_vect.E()
    b_jet2_m_obs    = jet_2_vect.M()
    b_jet2_btag_obs   = jet_2[i][5]
    b_jet3_px_obs   = jet_3_vect.Px()
    b_jet3_py_obs   = jet_3_vect.Py()
    b_jet3_pz_obs   = jet_3_vect.Pz()
    b_jet3_E_obs    = jet_3_vect.E()
    b_jet3_m_obs    = jet_3_vect.M()
    b_jet3_btag_obs   = jet_3[i][5]
    b_jet4_px_obs   = jet_4_vect.Px()
    b_jet4_py_obs   = jet_4_vect.Py()
    b_jet4_pz_obs   = jet_4_vect.Pz()
    b_jet4_E_obs    = jet_4_vect.E()
    b_jet4_m_obs    = jet_4_vect.M()
    b_jet4_btag_obs   = jet_4[i][5]
    b_jet5_px_obs   = jet_5_vect.Px()
    b_jet5_py_obs   = jet_5_vect.Py()
    b_jet5_pz_obs   = jet_5_vect.Pz()
    b_jet5_E_obs    = jet_5_vect.E()
    b_jet5_m_obs    = jet_5_vect.M()
    b_jet5_btag_obs   = jet_5[i][5]
    b_jetmu_px_obs   = jet_mu[i][0]
    b_jetmu_py_obs   = jet_mu[i][1]
    b_jetmu_pz_obs   = jet_mu[i][2]
    b_jetmu_T0_obs    = jet_mu[i][3]
    b_jetlep_ET_obs    = jet_mu[i][4]
    b_jetlep_phi_obs   = jet_mu[i][5]
