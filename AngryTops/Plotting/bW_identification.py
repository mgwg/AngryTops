...
def make_histograms():
    ...
    print('{}% 2 jet Hadronic Ws within cut, {} events'.format(100.*w_had_total_cuts[1]/w_had_jets[1], w_had_total_cuts[2]))
    ...
    print('{}% 2 jet Hadronic Ws, {} events'.format(100.*w_had_mass_cuts[1]/w_had_jets[1], w_had_mass_cuts[2]))
    ...
    print('{}% 2 jet Hadronic Ws, {} events'.format(100.*w_had_pT_cuts[1]/w_had_jets[1], w_had_pT_cuts[2]))
    ...
    print('{}% 2 jet Hadronic Ws, {} events'.format(100.*w_had_dist_cuts[1]/w_had_jets[1], w_had_dist_cuts[2]))
